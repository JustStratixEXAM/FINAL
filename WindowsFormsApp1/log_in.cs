...
namespace WindowsFormsApp1
{
    ...
    public partial class log_in : Form
    {
        ...
        private void button_Enter_Click(object sender, EventArgs e)
        {
            ...
            string queryString = $"select user_id, login, pwd, role from Users " +
            ...
            string history = $"insert into login_history(user_id, _time)";
                        history += $" values (1, '{DateTime.Now.ToString("yyyy-dd-MM HH:mm:ss")}')";
            ...
            if (table.Rows.Count == 1)
            {
                ...
                if (table.Rows[0].ItemArray[3].ToString() == "Кладовщик")
                {
                ...
                if (table.Rows[0].ItemArray[3].ToString() == "Заказчик")
                {
            ...
            else
            {
                ...
                MessageBox.Show("Вы ввели неверный логин или пароль", "Ошибка авторизации", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
